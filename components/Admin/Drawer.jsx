...
const Drawer = ({ edit, setEdit, element, formName, formID }) => {
  const formComponents = [
    {
      id: 1,
      formName: "Add Artist Form",
      element: <ArtistForm setEdit={setEdit} key={1} />,
    },
    {
      id: 2,
      formName: "Add Line Item Form",
      element: <LineItemForm setEdit={setEdit} key={2} />,
    },
    {
      id: 3,
      formName: "Add Order Form",
      element: <OrderForm setEdit={setEdit} key={3} />,
    },
    {
      id: 4,
      formName: "Add Track Form",
      element: <TrackForm setEdit={setEdit} key={4} />,
    },
    {
      id: 5,
      formName: "Add User Form",
      element: <UserForm setEdit={setEdit} key={5} />,
    },
    {
      id: 6,
      formName: "Add Vinyl Form",
      element: <VinylForm setEdit={setEdit} key={6} />,
    },
  ];
  return (
    <div
    ...
    bg-shade-9 p-4 border-r border-shade-1 border-opacity-30 shadow-lg
      overflow-y-auto
